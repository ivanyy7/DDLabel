...
- **PWA (п. 8.2):** можно «Добавить на главный экран» с телефона — иконка DDLabel, запуск без адресной строки
- **PWA (п. 8.2):** можно добавить на главный экран телефона — manifest.json, Service Worker, иконки 192×192 и 512×512
...
## PWA: «Добавить на главный экран»

На телефоне (Chrome/Edge Android, Safari iOS):

1. Откройте dd-label.vercel.app в браузере
2. Меню браузера → **«Добавить на главный экран»** / **«Установить приложение»**
3. Подтвердите — появится иконка DDLabel на главном экране
4. Запуск — без адресной строки, на весь экран (standalone)
